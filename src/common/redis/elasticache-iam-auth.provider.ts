...
import type { ISignedRequest } from '@app/types';
...
export class ElastiCacheIamAuthProvider {
     ...
     */
    private buildAuthTokenFromSignedRequest(signedRequest: ISignedRequest, username: string): string {
        const query = signedRequest.query ?? {};

        // Helper to get string value from query param (handles string | string[] | null)
