...
export class HttpOutboundInterceptor implements OnModuleInit {
    ...
    private handleRequest(config: InternalAxiosRequestConfig): InternalAxiosRequestConfig {
        ...
        (config as InternalAxiosRequestConfig & { __startTime?: number }).__startTime = startTime;
    ...
    private handleRequestError(error: unknown): Promise<never> {
        this.logger.error('HTTP Request preparation failed', error instanceof Error ? error.stack : undefined);
