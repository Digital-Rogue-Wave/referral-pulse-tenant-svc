...
import { IdempotencyKeyGenerator } from '@common/idempotency/idempotency-key.generator';
import { IDEMPOTENCY_KEY, IdempotencyDecoratorOptions } from '@common/idempotency/idempotency.decorator';
...
export class IdempotencyInterceptor implements NestInterceptor<unknown, unknown> {
    ...
    intercept(context: ExecutionContext, next: CallHandler<unknown>): Observable<unknown> {
        ...
        const options = this.reflector.get<IdempotencyDecoratorOptions>(IDEMPOTENCY_KEY, context.getHandler());
