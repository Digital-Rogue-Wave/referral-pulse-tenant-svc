...
export class FakerHelpers {
     ...
     */
    static generateValue(fieldName: string, fieldType: string): string | number | boolean | Date | Record<string, string> {
     ...
     */
    static generateByType(fieldType: string): string | number | boolean | Date | Record<string, string> {
