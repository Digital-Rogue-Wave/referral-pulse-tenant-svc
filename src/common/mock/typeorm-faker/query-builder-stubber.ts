...
import { ObjectLiteral, SelectQueryBuilder, UpdateQueryBuilder, UpdateResult } from 'typeorm';
...
export class QueryBuilderStubber {
    ...
    _stubUpdateQueryBuilder<T extends ObjectLiteral>(sandbox: SinonSandbox): SinonStubbedInstance<UpdateQueryBuilder<T>> {
        const updateQueryBuilderStub = sandbox.createStubInstance(UpdateQueryBuilder);
