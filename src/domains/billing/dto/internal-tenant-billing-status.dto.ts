...
export class InternalTenantBillingStatusDto {
    ...
    @ApiPropertyOptional({
        description: 'Trial start timestamp, when applicable',
    })
    ...
    @ApiPropertyOptional({
        description: 'Stripe customer identifier, when applicable',
    })
    stripeCustomerId?: string | null;

    @ApiPropertyOptional({
        description: 'Stripe subscription identifier, when applicable',
    })
