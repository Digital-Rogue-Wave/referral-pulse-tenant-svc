...
import { PlanLimits } from '@app/features/billing/plan-limits.type';
...
export class CreatePlanDto {
    ...
    @ApiPropertyOptional({
        description: 'Tenant this plan is specific to (null = public plan)',
    })
    @IsOptional()
    @IsUUID()
    ...
    @ApiPropertyOptional({
        description: 'Whether this plan uses manual invoicing (enterprise only)',
        default: false,
    })
    @IsOptional()
    @IsBoolean()
