...
export class SubscriptionStatusDto {
    ...
    @ApiPropertyOptional({
        description:
            'Stripe transaction (Payment Intent) identifier associated with the latest billing event, when applicable',
    })
    ...
    @ApiPropertyOptional({
        description:
            'End of the current billing period for the Stripe subscription in ISO-8601 format, when applicable',
    })
