...
describe('Auth member (e2e)', () => {
    ...
    it('Do not allow register member with exists email: /api/v1/auth/email/register (POST)', () => {
        return request(app)
    ...
    it('Register new member: /api/v1/auth/email/register (POST)', async () => {
        return request(app)
            .post('/api/v1/auth/email/register')
            .send({
                email: newUserEmail,
    ...
    it('Login unconfirmed member: /api/v1/auth/email/login (POST)', () => {
        return request(app)
            .post('/api/v1/auth/email/login')
    ...
    it('Login confirmed member: /api/v1/auth/email/login (POST)', () => {
        return request(app)
            .post('/api/v1/auth/email/login')
            .send({ email: newUserEmail, password: newUserPassword })
            .expect(200)
    ...
    it('Confirmed member retrieve profile: /api/v1/auth/me (GET)', async () => {
    ...
    it('New member update profile: /api/v1/auth/me (PATCH)', async () => {
    ...
    it('New member delete profile: /api/v1/auth/me (DELETE)', async () => {
        const newUserApiToken = await request(app)
            .post('/api/v1/auth/email/login')
            .send({ email: newUserEmail, password: newUserPassword })
            .then(({ body }) => body.token);
